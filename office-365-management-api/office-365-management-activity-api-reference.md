...
- <span data-ttu-id="c4c9a-153">**利用可能なコンテンツのリストの作成**。これには対応するコンテンツの URL も含まれます。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-153">**List available content** and the corresponding content URLs.</span></span>
...
|<span data-ttu-id="c4c9a-238">**応答**</span><span class="sxs-lookup"><span data-stu-id="c4c9a-238">**Response**</span></span>|<span data-ttu-id="c4c9a-239">JSON 配列</span><span class="sxs-lookup"><span data-stu-id="c4c9a-239">JSON array</span></span>|<span data-ttu-id="c4c9a-240">各サブスクリプションは、次の 3 つのプロパティが指定された JSON オブジェクトで表されます。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-240">Each subscription will be represented by a JSON object with three properties:</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-241"><b>contentType</b>:コンテンツ タイプを示します。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-241"><b>contentType</b>: Indicates the content type.</span></span></p></li><li><p><span data-ttu-id="c4c9a-242"><b>status</b>: Indicates the status of the subscription.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-242"><b>status</b>: Indicates the status of the subscription.</span></span></p></li><li><p><span data-ttu-id="c4c9a-p119"><b>webhook</b>: Indicates the configured webhook, together with the status (enabled, disabled, expired) of the webhook.  If a subscription does not have a webhook, the webhook property will be present but with null value.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p119"><b>webhook</b>: Indicates the configured webhook, together with the status (enabled, disabled, expired) of the webhook.  If a subscription does not have a webhook, the webhook property will be present but with null value.</span></span></p></li></ul>|
...
- <span data-ttu-id="c4c9a-304">**clientId**:サブスクリプションを作成したアプリケーションの GUID です。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-304">**clientId**: The GUID of your application that created the subscription.</span></span>
...
<span data-ttu-id="c4c9a-p143">サービスでエラーが検出されると、標準の HTTP エラー コードの構文を使用して、エラー応答コードが呼び出し元に報告されます。失敗した呼び出しの本体には、追加情報が単一の JSON オブジェクトとして含められます。完全な JSON エラー本体の例を以下に示します。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p143">When the service encounters an error, it will report the error response code to the caller, using standard HTTP error-code syntax. . Additional information is included in the body of the failed call as a single JSON object. An example of a full JSON error body is shown below:</span></span> 
...
|||
|:-----|:-----|
|<span data-ttu-id="c4c9a-409">コード</span><span class="sxs-lookup"><span data-stu-id="c4c9a-409">Code</span></span>|<span data-ttu-id="c4c9a-410">メッセージ</span><span class="sxs-lookup"><span data-stu-id="c4c9a-410">Message</span></span>|
|<span data-ttu-id="c4c9a-411">AF10001</span><span class="sxs-lookup"><span data-stu-id="c4c9a-411">AF10001</span></span>|<span data-ttu-id="c4c9a-412">要求で送信されたアクセス許可セット ({0}) に、必要なアクセス許可 **ActivityFeed.Read** が含まれていませんでした。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-412">The permission set ({0}) sent in the request did not include the expected permission **ActivityFeed.Read**.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-413">{0} = the permission set in the access token.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-413">{0} = the permission set in the access token.</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-414">AF20001</span><span class="sxs-lookup"><span data-stu-id="c4c9a-414">AF20001</span></span>|<span data-ttu-id="c4c9a-415">Missing parameter: {0}.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-415">Missing parameter: {0}.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-416">{0} = 不足しているパラメーターの名前。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-416">{0} = the name of the missing parameter.</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-417">AF20002</span><span class="sxs-lookup"><span data-stu-id="c4c9a-417">AF20002</span></span>|<span data-ttu-id="c4c9a-p144">無効なパラメーターの種類です: {0}。 予期される種類: {1}</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p144">Invalid parameter type: {0}. Expected type: {1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-420">{0} = the name of the invalid parameter.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-420">{0} = the name of the invalid parameter.</span></span></p></li><li><p><span data-ttu-id="c4c9a-421">{1} = the expected type (int, datetime, guid).</span><span class="sxs-lookup"><span data-stu-id="c4c9a-421">{1} = the expected type (int, datetime, guid).</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-422">AF20003</span><span class="sxs-lookup"><span data-stu-id="c4c9a-422">AF20003</span></span>|<span data-ttu-id="c4c9a-423">指定した有効期限 {0} は、過去の日付と時刻に設定されています。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-423">Expiration {0} provided is set to past date and time.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-424">{0} = API 呼び出しに渡される有効期限。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-424">{0} = the expiration passed in the API call.</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-425">AF20010</span><span class="sxs-lookup"><span data-stu-id="c4c9a-425">AF20010</span></span>|<span data-ttu-id="c4c9a-426">URL ({0}) で渡されたテナント ID が、アクセス トークン ({1}) で渡されたテナント ID と一致しません。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-426">The tenant ID passed in the URL ({0}) does not match the tenant ID passed in the access token ({1}).</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-427">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="c4c9a-427">{0} = tenant ID passed in the URL</span></span></p></li><li><p><span data-ttu-id="c4c9a-428">{1} = tenant ID passed in the access token</span><span class="sxs-lookup"><span data-stu-id="c4c9a-428">{1} = tenant ID passed in the access token</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-429">AF20011</span><span class="sxs-lookup"><span data-stu-id="c4c9a-429">AF20011</span></span>|<span data-ttu-id="c4c9a-430">指定したテナント ID ({0}) は、システムに存在しないか、削除されています。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-430">Specified tenant ID ({0}) does not exist in the system or has been deleted.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>   <span data-ttu-id="c4c9a-431">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="c4c9a-431">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-432">AF20012</span><span class="sxs-lookup"><span data-stu-id="c4c9a-432">AF20012</span></span>|<span data-ttu-id="c4c9a-433">指定したテナント ID ({0}) が、システムで正しく構成されていません。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-433">Specified tenant ID ({0}) is incorrectly configured in the system.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>    <span data-ttu-id="c4c9a-434">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="c4c9a-434">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-435">AF20013</span><span class="sxs-lookup"><span data-stu-id="c4c9a-435">AF20013</span></span>|<span data-ttu-id="c4c9a-436">URL ({0}) で渡されたテナント ID は、有効な GUID ではありません。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-436">The tenant ID passed in the URL ({0}) is not a valid GUID.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p> <span data-ttu-id="c4c9a-437">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="c4c9a-437">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-438">AF20020</span><span class="sxs-lookup"><span data-stu-id="c4c9a-438">AF20020</span></span>|<span data-ttu-id="c4c9a-439">指定したコンテンツ タイプが無効です。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-439">The specified content type is not valid.</span></span>|
|<span data-ttu-id="c4c9a-440">AF20021</span><span class="sxs-lookup"><span data-stu-id="c4c9a-440">AF20021</span></span>|<span data-ttu-id="c4c9a-p145">The webhook endpoint {{0}) could not be validated. {1}</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p145">The webhook endpoint {{0}) could not be validated. {1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-443">{0} = webhook address.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-443">{0} = webhook address.</span></span></p></li><li><p><span data-ttu-id="c4c9a-p146">{1} = "The endpoint did not return HTTP 200." or "The address must begin with HTTPS."</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p146">{1} = "The endpoint did not return HTTP 200." or "The address must begin with HTTPS."</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-446">AF20022</span><span class="sxs-lookup"><span data-stu-id="c4c9a-446">AF20022</span></span>|<span data-ttu-id="c4c9a-447">指定したコンテンツ タイプのサブスクリプションがありません。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-447">No subscription found for the specified content type.</span></span>|
|<span data-ttu-id="c4c9a-448">AF20023</span><span class="sxs-lookup"><span data-stu-id="c4c9a-448">AF20023</span></span>|<span data-ttu-id="c4c9a-449">The subscription was disabled by {0}.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-449">The subscription was disabled by {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-450">{0} = "テナント管理" または "サービス管理"</span><span class="sxs-lookup"><span data-stu-id="c4c9a-450">{0} = "a tenant admin" or "a service admin"</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-451">AF20030</span><span class="sxs-lookup"><span data-stu-id="c4c9a-451">AF20030</span></span>|<span data-ttu-id="c4c9a-452">開始時刻と終了時刻の両方を指定する (または両方を省略する) 必要があります。その時間差は 24 時間を超えてはならず、開始時刻は過去 7 日以内でなければなりません。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-452">Start time and end time must both be specified (or both omitted) and must be less than or equal to 24 hours apart, with the start time no more than 7 days in the past.</span></span>|
|<span data-ttu-id="c4c9a-453">AF20031</span><span class="sxs-lookup"><span data-stu-id="c4c9a-453">AF20031</span></span>|<span data-ttu-id="c4c9a-454">Invalid nextPage Input: {0}.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-454">Invalid nextPage Input: {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-455">{0} = URL に渡された次ページ インジケーター</span><span class="sxs-lookup"><span data-stu-id="c4c9a-455">{0} = the next page indicator passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-456">AF20050</span><span class="sxs-lookup"><span data-stu-id="c4c9a-456">AF20050</span></span>|<span data-ttu-id="c4c9a-457">指定された ID が存在しません。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-457">The specified content ({0}) does not exist.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-458">{0} = リソース ID またはリソース URL。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-458">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-459">AF20051</span><span class="sxs-lookup"><span data-stu-id="c4c9a-459">AF20051</span></span>|<span data-ttu-id="c4c9a-p147">Content requested with the key {0} has already expired. Content older than 7 days cannot be retrieved.</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p147">Content requested with the key {0} has already expired. Content older than 7 days cannot be retrieved.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-462">•    {0} = resource id or resource URL</span><span class="sxs-lookup"><span data-stu-id="c4c9a-462">•    {0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-463">AF20052</span><span class="sxs-lookup"><span data-stu-id="c4c9a-463">AF20052</span></span>|<span data-ttu-id="c4c9a-464">URL 内のコンテンツの ID {0} は無効です。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-464">Content ID {0} in the URL is invalid.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-465">{0} = リソース ID またはリソース URL。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-465">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-466">AF20053</span><span class="sxs-lookup"><span data-stu-id="c4c9a-466">AF20053</span></span>|<span data-ttu-id="c4c9a-467">Accept-Language ヘッダーには、1 つの言語のみ表示可能です。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-467">Only one language may be present in the Accept-Language header.</span></span>|
|<span data-ttu-id="c4c9a-468">AF20054</span><span class="sxs-lookup"><span data-stu-id="c4c9a-468">AF20054</span></span>|<span data-ttu-id="c4c9a-469">Accept-Language ヘッダーに無効な構文があります。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-469">Invalid syntax in Accept-Language header.</span></span>|
|<span data-ttu-id="c4c9a-470">AF429</span><span class="sxs-lookup"><span data-stu-id="c4c9a-470">AF429</span></span>|<span data-ttu-id="c4c9a-471">要求数が多すぎます。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-471">Too many requests.</span></span> <span data-ttu-id="c4c9a-472">メソッド={0}, PublisherId={1}</span><span class="sxs-lookup"><span data-stu-id="c4c9a-472">Method={0}, PublisherId={1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="c4c9a-473">{0} = HTTP メソッド</span><span class="sxs-lookup"><span data-stu-id="c4c9a-473">{0} = HTTP Method</span></span></p></li><li><p><span data-ttu-id="c4c9a-474">{1} = PublisherIdentifier として使用されたテナント GUID</span><span class="sxs-lookup"><span data-stu-id="c4c9a-474">{1} = Tenant GUID used as PublisherIdentifier</span></span></p></li></ul>|
|<span data-ttu-id="c4c9a-475">AF50000</span><span class="sxs-lookup"><span data-stu-id="c4c9a-475">AF50000</span></span>|<span data-ttu-id="c4c9a-p149">内部エラーが発生しました。要求を再試行してください。</span><span class="sxs-lookup"><span data-stu-id="c4c9a-p149">An internal error occurred. Retry the request.</span></span>|
