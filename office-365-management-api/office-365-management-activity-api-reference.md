...
<span data-ttu-id="d12ee-143">**Enterprise プラン**</span><span class="sxs-lookup"><span data-stu-id="d12ee-143">**Enterprise plan**</span></span>
...
- <span data-ttu-id="d12ee-155">**コンテンツの取得**。コンテンツ URL を使用して実行します。</span><span class="sxs-lookup"><span data-stu-id="d12ee-155">**Retrieving content** by using the content URL.</span></span>
...
|<span data-ttu-id="d12ee-238">**応答**</span><span class="sxs-lookup"><span data-stu-id="d12ee-238">**Response**</span></span>|<span data-ttu-id="d12ee-239">JSON 配列</span><span class="sxs-lookup"><span data-stu-id="d12ee-239">JSON array</span></span>|<span data-ttu-id="d12ee-240">各サブスクリプションは、次の 3 つのプロパティが指定された JSON オブジェクトで表されます。</span><span class="sxs-lookup"><span data-stu-id="d12ee-240">Each subscription will be represented by a JSON object with three properties:</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-241"><b>contentType</b>:コンテンツ タイプを示します。</span><span class="sxs-lookup"><span data-stu-id="d12ee-241"><b>contentType</b>: Indicates the content type.</span></span></p></li><li><p><span data-ttu-id="d12ee-242"><b>status</b>: サブスクリプションの状態を示します。</span><span class="sxs-lookup"><span data-stu-id="d12ee-242"><b>status</b>: Indicates the status of the subscription.</span></span></p></li><li><p><span data-ttu-id="d12ee-p119"><b>webhook</b>: Indicates the configured webhook, together with the status (enabled, disabled, expired) of the webhook.  If a subscription does not have a webhook, the webhook property will be present but with null value.</span><span class="sxs-lookup"><span data-stu-id="d12ee-p119"><b>webhook</b>: Indicates the configured webhook, together with the status (enabled, disabled, expired) of the webhook.  If a subscription does not have a webhook, the webhook property will be present but with null value.</span></span></p></li></ul>|
...
- <span data-ttu-id="d12ee-305">**contentType**:コンテンツ タイプを示します。</span><span class="sxs-lookup"><span data-stu-id="d12ee-305">**contentType**: Indicates the content type.</span></span>
...
|<span data-ttu-id="d12ee-425">AF20010</span><span class="sxs-lookup"><span data-stu-id="d12ee-425">AF20010</span></span>|<span data-ttu-id="d12ee-426">URL ({0}) で渡されたテナント ID が、アクセス トークン ({1}) で渡されたテナント ID と一致しません。</span><span class="sxs-lookup"><span data-stu-id="d12ee-426">The tenant ID passed in the URL ({0}) does not match the tenant ID passed in the access token ({1}).</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-427">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="d12ee-427">{0} = tenant ID passed in the URL</span></span></p></li><li><p><span data-ttu-id="d12ee-428">{1} = tenant ID passed in the access token</span><span class="sxs-lookup"><span data-stu-id="d12ee-428">{1} = tenant ID passed in the access token</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-429">AF20011</span><span class="sxs-lookup"><span data-stu-id="d12ee-429">AF20011</span></span>|<span data-ttu-id="d12ee-430">指定したテナント ID ({0}) は、システムに存在しないか、削除されています。</span><span class="sxs-lookup"><span data-stu-id="d12ee-430">Specified tenant ID ({0}) does not exist in the system or has been deleted.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>   <span data-ttu-id="d12ee-431">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="d12ee-431">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-432">AF20012</span><span class="sxs-lookup"><span data-stu-id="d12ee-432">AF20012</span></span>|<span data-ttu-id="d12ee-433">指定したテナント ID ({0}) が、システムで正しく構成されていません。</span><span class="sxs-lookup"><span data-stu-id="d12ee-433">Specified tenant ID ({0}) is incorrectly configured in the system.</span></span> <ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p>    <span data-ttu-id="d12ee-434">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="d12ee-434">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-435">AF20013</span><span class="sxs-lookup"><span data-stu-id="d12ee-435">AF20013</span></span>|<span data-ttu-id="d12ee-436">URL ({0}) で渡されたテナント ID は、有効な GUID ではありません。</span><span class="sxs-lookup"><span data-stu-id="d12ee-436">The tenant ID passed in the URL ({0}) is not a valid GUID.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p> <span data-ttu-id="d12ee-437">{0} = tenant ID passed in the URL</span><span class="sxs-lookup"><span data-stu-id="d12ee-437">{0} = tenant ID passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-438">AF20020</span><span class="sxs-lookup"><span data-stu-id="d12ee-438">AF20020</span></span>|<span data-ttu-id="d12ee-439">指定したコンテンツ タイプが無効です。</span><span class="sxs-lookup"><span data-stu-id="d12ee-439">The specified content type is not valid.</span></span>|
|<span data-ttu-id="d12ee-440">AF20021</span><span class="sxs-lookup"><span data-stu-id="d12ee-440">AF20021</span></span>|<span data-ttu-id="d12ee-p145">The webhook endpoint {{0}) could not be validated. {1}</span><span class="sxs-lookup"><span data-stu-id="d12ee-p145">The webhook endpoint {{0}) could not be validated. {1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-443">{0} = Webhook アドレス。</span><span class="sxs-lookup"><span data-stu-id="d12ee-443">{0} = webhook address.</span></span></p></li><li><p><span data-ttu-id="d12ee-p146">{1} = "The endpoint did not return HTTP 200." or "The address must begin with HTTPS."</span><span class="sxs-lookup"><span data-stu-id="d12ee-p146">{1} = "The endpoint did not return HTTP 200." or "The address must begin with HTTPS."</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-446">AF20022</span><span class="sxs-lookup"><span data-stu-id="d12ee-446">AF20022</span></span>|<span data-ttu-id="d12ee-447">指定したコンテンツ タイプのサブスクリプションがありません。</span><span class="sxs-lookup"><span data-stu-id="d12ee-447">No subscription found for the specified content type.</span></span>|
|<span data-ttu-id="d12ee-448">AF20023</span><span class="sxs-lookup"><span data-stu-id="d12ee-448">AF20023</span></span>|<span data-ttu-id="d12ee-449">The subscription was disabled by {0}.</span><span class="sxs-lookup"><span data-stu-id="d12ee-449">The subscription was disabled by {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-450">{0} = "テナント管理" または "サービス管理"</span><span class="sxs-lookup"><span data-stu-id="d12ee-450">{0} = "a tenant admin" or "a service admin"</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-451">AF20030</span><span class="sxs-lookup"><span data-stu-id="d12ee-451">AF20030</span></span>|<span data-ttu-id="d12ee-452">開始時刻と終了時刻の両方を指定する (または両方を省略する) 必要があります。その時間差は 24 時間を超えてはならず、開始時刻は過去 7 日以内でなければなりません。</span><span class="sxs-lookup"><span data-stu-id="d12ee-452">Start time and end time must both be specified (or both omitted) and must be less than or equal to 24 hours apart, with the start time no more than 7 days in the past.</span></span>|
|<span data-ttu-id="d12ee-453">AF20031</span><span class="sxs-lookup"><span data-stu-id="d12ee-453">AF20031</span></span>|<span data-ttu-id="d12ee-454">Invalid nextPage Input: {0}.</span><span class="sxs-lookup"><span data-stu-id="d12ee-454">Invalid nextPage Input: {0}.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-455">{0} = URL に渡された次ページ インジケーター</span><span class="sxs-lookup"><span data-stu-id="d12ee-455">{0} = the next page indicator passed in the URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-456">AF20050</span><span class="sxs-lookup"><span data-stu-id="d12ee-456">AF20050</span></span>|<span data-ttu-id="d12ee-457">指定された ID が存在しません。</span><span class="sxs-lookup"><span data-stu-id="d12ee-457">The specified content ({0}) does not exist.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-458">{0} = リソース ID またはリソース URL。</span><span class="sxs-lookup"><span data-stu-id="d12ee-458">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-459">AF20051</span><span class="sxs-lookup"><span data-stu-id="d12ee-459">AF20051</span></span>|<span data-ttu-id="d12ee-p147">Content requested with the key {0} has already expired. Content older than 7 days cannot be retrieved.</span><span class="sxs-lookup"><span data-stu-id="d12ee-p147">Content requested with the key {0} has already expired. Content older than 7 days cannot be retrieved.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-462">•    {0} = resource id or resource URL</span><span class="sxs-lookup"><span data-stu-id="d12ee-462">•    {0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-463">AF20052</span><span class="sxs-lookup"><span data-stu-id="d12ee-463">AF20052</span></span>|<span data-ttu-id="d12ee-464">URL 内のコンテンツの ID {0} は無効です。</span><span class="sxs-lookup"><span data-stu-id="d12ee-464">Content ID {0} in the URL is invalid.</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-465">{0} = リソース ID またはリソース URL。</span><span class="sxs-lookup"><span data-stu-id="d12ee-465">{0} = resource id or resource URL</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-466">AF20053</span><span class="sxs-lookup"><span data-stu-id="d12ee-466">AF20053</span></span>|<span data-ttu-id="d12ee-467">Accept-Language ヘッダーには、1 つの言語のみ表示可能です。</span><span class="sxs-lookup"><span data-stu-id="d12ee-467">Only one language may be present in the Accept-Language header.</span></span>|
|<span data-ttu-id="d12ee-468">AF20054</span><span class="sxs-lookup"><span data-stu-id="d12ee-468">AF20054</span></span>|<span data-ttu-id="d12ee-469">Accept-Language ヘッダーに無効な構文があります。</span><span class="sxs-lookup"><span data-stu-id="d12ee-469">Invalid syntax in Accept-Language header.</span></span>|
|<span data-ttu-id="d12ee-470">AF429</span><span class="sxs-lookup"><span data-stu-id="d12ee-470">AF429</span></span>|<span data-ttu-id="d12ee-471">要求数が多すぎます。</span><span class="sxs-lookup"><span data-stu-id="d12ee-471">Too many requests.</span></span> <span data-ttu-id="d12ee-472">メソッド={0}, PublisherId={1}</span><span class="sxs-lookup"><span data-stu-id="d12ee-472">Method={0}, PublisherId={1}</span></span><ul xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:mtps="http://msdn2.microsoft.com/mtps" xmlns:mshelp="http://msdn.microsoft.com/mshelp" xmlns:ddue="http://ddue.schemas.microsoft.com/authoring/2003/5" xmlns:msxsl="urn:schemas-microsoft-com:xslt"><li><p><span data-ttu-id="d12ee-473">{0} = HTTP メソッド</span><span class="sxs-lookup"><span data-stu-id="d12ee-473">{0} = HTTP Method</span></span></p></li><li><p><span data-ttu-id="d12ee-474">{1} = PublisherIdentifier として使用されたテナント GUID</span><span class="sxs-lookup"><span data-stu-id="d12ee-474">{1} = Tenant GUID used as PublisherIdentifier</span></span></p></li></ul>|
|<span data-ttu-id="d12ee-475">AF50000</span><span class="sxs-lookup"><span data-stu-id="d12ee-475">AF50000</span></span>|<span data-ttu-id="d12ee-p149">内部エラーが発生しました。要求を再試行してください。</span><span class="sxs-lookup"><span data-stu-id="d12ee-p149">An internal error occurred. Retry the request.</span></span>|
